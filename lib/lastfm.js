...
LastFM.get_text = function(lastfm_obj, property) {
    lastfm_obj = lastfm_obj || {};
    if(typeof(lastfm_obj[property]) === "string") {
        // This is what we want
        return lastfm_obj[property];
    } else if(typeof(lastfm_obj[property]) === "object") {
        // Try the #text property
        if (typeof(lastfm_obj[property]["#text"]) === "string") {
            return lastfm_obj[property]["#text"];
        }
    } else {
        // Look in the @attr object
        var attributes = lastfm_obj["@attr"] || {};
